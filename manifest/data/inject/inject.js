...
capture = (function() {
  ...
  function remove() {
    chrome.runtime.sendMessage({
      ...
      service: window.service // Usa Reverse Image Search extension
    });
    guide.remove();
    capture.remove();
    monitor.remove();
  ...
  function mousedown(e) {
    ...
    document.addEventListener('mousemove', update); //Responsavel pela seleção
    document.addEventListener('mouseup', remove); // resaponsavel por tirar a seleção
